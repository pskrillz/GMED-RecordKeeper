...
export class TableViewComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    public _tableData: TableDataService) {}
  ...
  columnDefs = [
      ...
      {headerName: 'Request By', field: 'reqBy',  editable: true, sortable: true, filter: true},
      {headerName: 'Date', field: 'reqDate',  editable: true, sortable: true, filter: true },
      ...
      {headerName: "Comment", field: "description",  editable: true, sortable: true, filter: true },
